...
export default function Sidebar(props) {
  return(
    <aside id="section-sidebar" className="flex flex-shrink-0 sm:py-3 w-full h-[75px] sm:w-[75px]  sm:h-full fixed bottom-0 z-10 bg-white shadow-md">
      <div className="flex h-full w-full flex-row sm:flex-col">
        <div id="menu" className="w-full py-2 px-3 flex sm:flex-col justify-between">
          ...
          <Link href="/notifications" title="Notifications" className="focus:outline-none group m-0 flex justify-center min-h-4 w-full cursor-pointer items-center rounded-xl px-4 font-medium hover:bg-blue-100 p-4 text-blue-900">
            <div className="h-4 w-4">
