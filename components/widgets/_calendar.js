  ...
  return (
    <div className="overflow-scroll rounded-lg bg-blue-200 shadow-sm w-full h-full p-6">
      ...
      <div className="flex flex-row justify-start content-center w-full">
        <button onClick={() => props.setDay(today)} className="flex flex-col justify-center content-center rounded-full text-blue-900 bg-blue-100 hover:bg-blue-50 py-1 px-5">Today</button>
        <div className="text-blue-950 font-bold text-lg mx-auto">{formatDate(props.day)}</div>
